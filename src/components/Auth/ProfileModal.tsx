...
interface ProfileModalProps {
  ...
  /*
   * embedded=true makes Account behave like a normal
   * customer page instead of a popup.
   */
  embedded?: boolean;
}
...
> = ({
  ...
  const [residence, setResidence] =
    useState(
      userProfile?.residence ||
        'Main Hostel Block B, Room 14'
    );

  const [
    preferredDropSpotId,
    setPreferredDropSpotId,
  ] = useState(
  ...
  const [recipientPhoto, setRecipientPhoto] =
    useState(
  ...
  const [privilegeMsg, setPrivilegeMsg] =
    useState<{
      type: 'success' | 'error';
      text: string;
    } | null>(null);

  const [savedSuccessMsg, setSavedSuccessMsg] =
    useState(false);

  const [roleErrorNotice, setRoleErrorNotice] =
  ...
  const handlePhotoFileUpload =
    async (
      ...
      try {
        ...
        console.warn(
          'Could not compress profile photo, using original:',
          err
        );
  ...
  const handleSaveProfile = async (
    ...
    try {
      ...
      localStorage.setItem(
        'steamz_saved_residence',
        residence
      );

      localStorage.setItem(
        'steamz_saved_recipient_photo',
        recipientPhoto
      );
    } catch {
  ...
  const handleRoleSwitch = async (
    ...
    if (
      ...
      setRoleErrorNotice(
        `Access Restricted: Only ${SUPER_ADMIN_EMAIL} has the authority to grant the Admin tag. You cannot self-assign this role.`
      );
    ...
    if (
      ...
      setRoleErrorNotice(
        `Access Restricted: Only ${SUPER_ADMIN_EMAIL} has the authority to grant the Restaurant Owner tag. You cannot self-assign this role.`
      );
  ...
  const handleGrantPrivilegeSubmit =
    async (
      e: React.FormEvent
    ) => {
      e.preventDefault();
        ...
        setPrivilegeMsg({
          ...
          text: `Granted ${
            targetRole === 'admin'
              ? 'Admin'
              : 'Restaurant Owner'
          } privileges to ${targetEmail.trim()}.`,
        });
  ...
  const handleRevokePrivilegeSubmit =
    async (email: string) => {
      setPrivilegeMsg(null);
  ...
  const currentSpot =
    dropSpots.find(
      (s) =>
        s.id === preferredDropSpotId
    ) || dropSpots[0];

  const wrapperClass = embedded
    ? 'w-full max-w-3xl mx-auto'
    : 'fixed inset-0 z-50 flex items-center justify-center bg-stone-900/60 backdrop-blur-xs p-3 sm:p-4 overflow-y-auto';

  const panelClass = embedded
    ? 'w-full rounded-3xl bg-white border border-stone-200 shadow-sm overflow-hidden'
    : 'w-full max-w-xl max-h-[92vh] flex flex-col rounded-3xl bg-white shadow-2xl border border-stone-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200';
  ...
  return (
    <div className={wrapperClass}>
      ...
      <div className={panelClass}>
        ...
        <div className="flex border-b border-stone-200 bg-stone-50/40 px-6 gap-2 pt-2 overflow-x-auto">
          ...
          <button
            ...
            className={`pb-2.5 text-xs font-bold border-b-2 transition flex items-center gap-1.5 whitespace-nowrap ${
              activeTab === 'profile'
            ...
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="text-xs truncate">
                ...
                <span className="font-extrabold text-orange-950 block">
                  Restaurant Owner Tag Active 🎉
                </span>

                <span className="text-orange-700 text-[11px] truncate block">
                  Authorized by Super Admin to manage menus & live batch orders.
                </span>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          {savedSuccessMsg && (
            <div className="p-3 rounded-2xl bg-emerald-50 border border-emerald-200 text-xs text-emerald-800 font-bold flex items-center gap-2 animate-in fade-in">
              ...
              <span>
                Settings saved! Your WhatsApp and delivery details are permanently updated.
              </span>
            ...
            >
              ...
              <div className="bg-emerald-50/70 p-4 rounded-2xl border border-emerald-200 space-y-1.5">
                ...
                <label className="block text-xs font-extrabold text-emerald-950 flex items-center gap-1.5">
                  ...
                  <span>
                    WhatsApp Number (Permanent Delivery Contact)
                  </span>
                </label>
              ...
              <div>
                ...
                <label className="block text-xs font-bold text-stone-700 mb-1 flex items-center gap-1.5">
                  ...
                  <span>
                    University Residence (Hostel, Hall, or Off-Campus Residence)
                  </span>
                </label>
              ...
              <div>
                ...
                <label className="block text-xs font-bold text-stone-700 mb-1 flex items-center gap-1.5">
                  ...
                  <span>
                    Preferred Pickup Delivery Spot
                  </span>
                </label>
          ...
          {activeTab ===
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 rounded-2xl bg-amber-50 border border-amber-200 text-xs text-amber-950">
                ...
                Users cannot self-assign Admin or Restaurant Owner roles. Only the designated platform authority (
                <strong className="text-stone-900">
                  {SUPER_ADMIN_EMAIL}
                </strong>
                ) possesses the privileges to grant or revoke Admin and Restaurant Owner tags.
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-xs text-stone-900 flex items-center gap-2">
                        ...
                        {userRole ===
                          'admin' && (
                          <span className="text-[10px] bg-stone-900 text-white px-2 py-0.5 rounded-full">
                            Active
                          </span>
                        )}
              ...
              {userRole ===
                ...
                <div className="pt-2">
                  ...
                  >
                    ...
                    <span>
                      Open Delivery Spots Picture & Admin Manager
                    </span>
                  </button>
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 rounded-2xl bg-amber-500/10 border border-amber-300 text-xs text-amber-950 flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <span className="text-stone-600 text-[11px] leading-relaxed block mt-0.5">
                    ...
                    , you hold exclusive authority to designate Admin and Restaurant Owner privileges. No other account can elevate their role or distribute roles.
                  </span>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-stone-500">
                          Platform Sovereign • Root Super Admin
                        </span>
              ...
              <div className="pt-2">
                ...
                >
                  ...
                  <span>
                    Open Campus Delivery Spots Manager
                  </span>
