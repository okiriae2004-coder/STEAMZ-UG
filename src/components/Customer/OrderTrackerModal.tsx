          ...
          <div className="rounded-2xl border border-stone-200 divide-y divide-stone-100 bg-white">
            ...
            {order.statusHistory.map(
              (item, idx) => (
                <div
                  key={idx}
                  className="p-3.5 flex items-start gap-3 text-xs"
                >

                  <span className="font-mono text-stone-400 shrink-0 font-medium">
                    {item.timestamp}
                  </span>
